import PublicScreen from 'views/PublicScreen/PublicScreen';
...
const appRoutes = [
    { path: "/", name: "PublicScreen", icon: "pe-7s-graph", component: PublicScreen },
    ...
    { redirect: true, path:"/", to:"/", name: "PublicScreen" }
];
